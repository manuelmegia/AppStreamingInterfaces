...
val seriesAccion
    get() = arrayListOf(
        Movie(
            1,
            "NOP",
            "Los dos residentes de un solitario barranco en el interior de California realizan un descubrimiento tan insólito como escalofriante.",
            R.drawable.nop,
            "4_5bUgvMOEc"
        ),
        Movie(
            ...
            R.drawable.the_jack_in_the_box,
            "BDLRWAya47Y"
        ),
        Movie(
            3,
        ...
        Movie(
            ...
            R.drawable.sonic_2_la_pelicula,
            "Mw64Q2bUCGo"
        ),
        Movie(
            6,
